...
-- position
insert into position (position_id, position_name) values (1, 'Manager Employee');
insert into position (position_id, position_name) values (2, 'Database Administrator');
insert into position (position_id, position_name) values (3, 'Registered receptionist');
insert into position (position_id, position_name) values (4, 'Structural Analysis Engineer');
insert into position (position_id, position_name) values (5, 'Budget/Accounting Analyst');
insert into position (position_id, position_name) values (6, 'Environmental Specialist');
insert into position (position_id, position_name) values (7, 'Attendant');
insert into position (position_id, position_name) values (8, 'Supervisor');
insert into position (position_id, position_name) values (9, 'security');
insert into position (position_id, position_name) values (10, 'HR');
insert into position (position_id, position_name) values (11, 'Sales');
insert into position (position_id, position_name) values (12, 'Director');
insert into position (position_id, position_name) values (13, 'Chef');
